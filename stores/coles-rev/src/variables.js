export const colesEverything = {
  url: 'https://shop.coles.com.au/a/richmond-south/everything/browse',
  postcode: 3000,
};
export const colesUrl = 'https://shop.coles.com.au';
export const ignoredCategoryList = ['Liquor', 'Tobacco'];

export const chemistCategoriesUrl =
  'https://www.chemistwarehouse.com.au/categories';
export const chemistUrl = 'https://www.chemistwarehouse.com.au';
